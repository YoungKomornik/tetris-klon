...
public:
    ...
    LShape()
    {
        ...
        blok[0].setPosition(obszarGry.getPozycja().x + obszarGry.getSzerokoscKrawedzi() + (2 * obszarGry.getJednaKratka()), obszarGry.getPozycja().y + obszarGry.getSzerokoscKrawedzi());
    ...
    void rotate()
    {
        ...
        case Orientation::Right:
            ...
            blok[3].setPosition(blok[0].getPosition() + Vector2f(obszarGry.getJednaKratka(), 2 * obszarGry.getJednaKratka()));
